...
/**
 * Unit tests for the ForTag which shall be able to sort and map collections so data pre-processing will be obsolete in
...
public class TestForTag
{
    ...
    private void checkValues(Matcher m, String name, String collection, String select, String order, String attribute)
    {
