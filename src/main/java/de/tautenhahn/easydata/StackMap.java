...
/**
 * Map where the values are kept in stacks. Several values can be added for the same key shadowing each other, upon
 * removal the previous value appears again. This supports recursively called macros. * @author tt
 */
