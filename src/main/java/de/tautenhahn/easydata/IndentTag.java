...
public class IndentTag extends ComplexTag
{
    ...
    IndentTag(Matcher startMatcher, Iterator<Token> remaining, String delim, String end, ResolverFactory factory)
    {
    ...
    public void resolve(Token start, AccessibleData data, Writer output) throws IOException
    {
        ...
        {
            try (Writer formatter = new FormattingWriter(output, otherContent.keySet().iterator().next().getContent()))
            {
